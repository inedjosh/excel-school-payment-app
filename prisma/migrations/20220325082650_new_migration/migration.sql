/*
  ...
  - Added the required column `sponsorPassport` to the `studentRegistration` table without a default value. This is not possible if the table is not empty.
  - Added the required column `studentPassport` to the `studentRegistration` table without a default value. This is not possible if the table is not empty.
